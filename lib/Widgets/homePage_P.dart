...
import 'package:training_1/db/auth_homePage_P.dart';
...
import 'package:training_1/Widgets/profile-PNavigation-bar.dart';
        ...
        setState(() {
          ...
          if (index == 1) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PatientProfileNavigationBar(),
              ),
            );
          }
        });
