...
class ProfilePageP extends StatefulWidget {
  const ProfilePageP({super.key});

  @override
  State<ProfilePageP> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<ProfilePageP> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildProfileOption(
                    ...
                    title: 'Appointment',
                    onTap: () {
                      Navigator.pushNamed(context, '/appointment-doctor');
                    },
                  ),
                  const SizedBox(height: 15),
                  _buildProfileOption(
