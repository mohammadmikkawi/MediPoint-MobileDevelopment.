...
class AppointmentsPageP extends StatefulWidget {
  const AppointmentsPageP({super.key});

  @override
  State<AppointmentsPageP> createState() => _AppointmentsPagePState();
}

class _AppointmentsPagePState extends State<AppointmentsPageP> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border:
            isAccepted ? Border.all(color: Colors.blue[300]!, width: 2) : null,
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.05),
            blurRadius: 10,
