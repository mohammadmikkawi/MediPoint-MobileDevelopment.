...
class Logo extends StatelessWidget {
  double? num;
  double? num2;
  Logo(this.num, this.num2, {super.key});
...
class Field extends StatelessWidget {
  ...
  Field({super.key, this.hinttext, required this.controller});
...
class Button extends StatelessWidget {
  ...
  Button(this.name, this.num3, {super.key, required this.onPressed});
...
class Signupwithtext extends StatelessWidget {
  const Signupwithtext({super.key});
...
class Flowbutton extends StatelessWidget {
  ...
  double num6;
  double num7;
  Flowbutton(this.keey, this.titlee, this.num6, this.num7, {super.key});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      width: num7,
            ...
            onPressed: () async {
              try {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      "Please fill all fields or check your email.",
                    ),
                  ),
                );
              }
